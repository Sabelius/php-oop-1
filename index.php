...
class Movie{
    ...
    function __construct($titolo, $regista, $dataUscita, $genere, $minutaggio){
        $this->titolo = $titolo;
...
$LOTR = new Movie("La compagnia dell'anello", "Peter Jackson", 2001, "Fantasy", 178);
...
$LOTR2 = new Movie("Le due Torri", "Peter Jackson", 2002, "Fantasy", 238);
...
$LOTR3 = new Movie("Il ritorno del re", "Peter Jackson", 2003, "Fantasy", 253);
